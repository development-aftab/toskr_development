...
@section('content')
                ...
                <div class="col-md-12 col-sm-12">
                    <div class="row dashboad_row1">
                        ...
                        <div class="col-md-8 col_right">
                            ...
                            <ul>
                                <li @if(Session::get('task_status') == '0') class="active" @endif><a href="{{ route('dashboard') }}">All</a></li>
                                <li @if(Session::get('task_status') == 'assigned') class="active" @endif><a href="{{ route('dashboard') }}/assigned">Assigned</a></li>
                                <li @if(Session::get('task_status') == 'inprogress') class="active" @endif><a href="{{ route('dashboard') }}/inprogress">in-Progress</a></li>
                                <li @if(Session::get('task_status') == 'completed') class="active" @endif><a href="{{ route('dashboard') }}/completed">Completed</a></li>
                            </ul>
                            <div class="labels">
                                <h4>Labels</h4>
                         ...
                         <div class="row dashboad_row2">
                              @foreach ($task as $element)
                                ...
                                ?>
                                @if(Carbon\Carbon::createFromTimestamp(strtotime($element->end_date)) > Carbon\Carbon::createFromTimestamp(strtotime(\Carbon\Carbon::now())))
                                  <?php
                                   $time ='Day Left';
                                  ?>
                                @else
                                ...
                                @endif
                                    <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                                        <div class="card_inner">
                                            <a href="{{ route('task_detial') }}/{{ $element->id }}"><i class="fa fa-edit" aria-hidden="true"></i></a>
                                            <div class="card_detail">
                                                <div @if($element->status == 'completed') style="background: #4caf50 !important;" @else @if($element->priority == 'High') style="background: #ed1c24 !important;" @elseif($element->priority == 'Medium') style="background: #fbe528 !important;" @elseif($element->priority == 'Low' ) style="background: #a4a4a4 !important;" @endif @endif    class="image"><img src="{{ asset('website') }}/webdesign.png"></div>
                                                <div class="desc">
                                                    <h4>{{ $element->project_name }}</h4>
                                                    <p>{{ $element->getCategoryDetail->name }}</p>
                                                </div>
                                            </div>
                                            <div class="card_tags">
                                                <span><i class="icon-paper-clip"></i> {{ $element->attachmentCount }}</span>
                                                <span><i class="icon-hourglass"></i> {{ $create_at_difference*24 }}</span>
                                                <span><i class="fa fa-users"></i>{{ $element->assignedCount }}</span>
                                                <span>@if($element->messageviewedCount > 0)<span class="dot"></span> @endif<i class="fa fa-comment" aria-hidden="true"></i>{{ $element->messageCount }}</span>
                                            </div>
                                            <hr>
                                            <div class="card_footer">
                                                <div>
                                                    <p>Progress</p>
                                                    <p @if($element->status == 'completed') style="background: #4caf50 !important;" @else @if($element->priority == 'High') style="background: #ed1c24 !important;" @elseif($element->priority == 'Medium') style="background: #fbe528 !important;" @elseif($element->priority == 'Low' ) style="background: #a4a4a4 !important;" @endif @endif class="badge badge-danger">@if($element->status == 'completed') <i class="fa fa-check"></i> Completed  @else <i class="icon-clock"></i>{{ $create_at_difference }} {{ $time }} @endif </p>
                                                </div>
                                                <div class="progress progress-sm">
                                                <div class="progress-bar progress-bar-success active progress-bar-striped"
                                                     aria-valuenow="85" aria-valuemin="0" aria-valuemax="100" style="width:{{ $element->bar_link }}%"
                                                     role="progressbar"><span class="sr-only">85% Complete (success)</span></div>
                            </div>
                                            </div>
                                            <a class="whole_link" href="{{ route('task_detial') }}/{{ $element->id }}"></a>
                                        </div>
                                ...
                                @endif
                                    <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12 search">
                                        <div class="card_inner">
                                            ...
                                            <a href="{{ route('task_detial') }}/{{ $element->id }}" class="whole_link"></a>
                                        </div>
                                            ...
                                            <div class="card_detail">
                                                ...
                                                <div class="desc">
                                                    ...
                                                    @if(auth()->user()->hasRole('employee'))
                                                      @if(App\TaskAssigned::where('employee_id',Auth::id())->where('task_id',$element->id)->first()->task_manager == 1) Task Owner @else Co-worker @endif
                                                    @endif
                                                </div>
                                            </div>
                                            <div class="card_tags">
  ...
  <div class="modal-dialog">
    ...
    <form method="POST" action="{{ url('/task/task') }}" accept-charset="UTF-8" class="form-horizontal" enctype="multipart/form-data">
      {{ csrf_field() }}
