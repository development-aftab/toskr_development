...
Route::get('/clear-all', function() {
    ...
    Route::get('features','WebsiteController@features')->name('features');
    Route::get('how_it_works','WebsiteController@howItWorks')->name('how_it_works');
    Route::post('contact_us_process','WebsiteController@contactUsProcess')->name('contact_us_process');
    Route::post('login_process','WebsiteController@loginProcess')->name('login_process');
    Route::group(['middleware' => ['auth', 'roles'],'roles' => ['admin','user','company','employee','Manager']], function () {
    Route::get('/dashboard/{status?}','WebsiteController@dashboard')->name('dashboard');
    Route::get('/myprofle','WebsiteController@myprofle')->name('myprofle');
    Route::get('/Contact','WebsiteController@Contact')->name('Contact');
    Route::get('/Notification','WebsiteController@Notification')->name('Notification');
    Route::get('/Personal','WebsiteController@Personal')->name('Personal');
    Route::get('/Security','WebsiteController@Security')->name('Security');
    Route::get('/get_coworker_request','WebsiteController@getCoworkerRequest')->name('get_coworker_request');
    Route::post('/request_to_coworker','WebsiteController@requestToCoworker')->name('request_to_coworker');
    
    Route::get('accept_task/{id?}','WebsiteController@acceptTask')->name('accept_task');
    Route::get('reject_task/{id?}','WebsiteController@rejectTask')->name('reject_task');
    Route::get('change_approval/{id?}/{status?}','WebsiteController@changeApproval')->name('change_approval');
    Route::get('account-settings','UsersController@getSettings');
    Route::post('account-settings','UsersController@saveSettings');
    Route::post('invitatio_send','WebsiteController@InvitatioSend')->name('invitatio_send');
    Route::get('request_type/{request_type?}/{id?}','WebsiteController@requestType')->name('request_type');
    Route::get('task_detial/{id?}','WebsiteController@taskDetial')->name('task_detial');
    Route::post('/get_message_process','ChatboxController@getMessageProcess')->name('get_message_process');
    Route::get('/get_message_process','ChatboxController@getMessageProcess')->name('get_message_process');
    Route::post('/send_message_process','ChatboxController@sendMessageProcess')->name('send_message_process');
    ...
    Route::get('/chat/{id?}', 'ChatboxController@index')->name('chat');
    Route::get('/get_message_count', 'WebsiteController@getMessageCount')->name('get_message_count');
    Route::get('/task_log/{id?}', 'WebsiteController@taskLog')->name('task_log');
    Route::post('create_group','ChatboxController@createGroup')->name('create_group');
    Route::post('create_task_note','WebsiteController@createTaskNote')->name('create_task_note');
    Route::post('update_contact','WebsiteController@updateContact')->name('update_contact');
    Route::post('email_update','WebsiteController@emailUpdate')->name('email_update');
    Route::post('dob_update','WebsiteController@dobUpdate')->name('dob_update');
    Route::post('phone_update','WebsiteController@phoneUpdate')->name('phone_update');
    Route::post('update_personal','WebsiteController@updatePersonal')->name('update_personal');
    Route::post('update_password','WebsiteController@updatePassword')->name('update_password');
    Route::post('user_image_change','WebsiteController@userImageChange')->name('user_image_change');
    Route::get('delete_group/{id?}','WebsiteController@deleteGroup')->name('delete_group');
    Route::get('group_detial/{id?}','WebsiteController@groupDetial')->name('group_detial');
    Route::post('edit_group','WebsiteController@editGroup')->name('edit_group');
    Route::post('address_update','WebsiteController@addressUpdate')->name('address_update');

});

Route::get('register_employee/{code?}','WebsiteController@registerEmployee')->name('register_employee');
Route::get('register_company','WebsiteController@registerCompany')->name('register_company');
Route::post('register_employee_procces','WebsiteController@registerEmployeeProcces')->name('register_employee_procces');
Route::post('register_company_procces','WebsiteController@registerCompanyProcces')->name('register_company_procces');
...
Route::resource('invitation/invitation', 'Invitation\\InvitationController');
Route::resource('task/task', 'Task\\TaskController');
Route::resource('taskCategory/task-category', 'TaskCategory\\TaskCategoryController');
Route::resource('taskAssigned/task-assigned', 'TaskAssigned\\TaskAssignedController');
Route::resource('taskDetail/task-detail', 'TaskDetail\\TaskDetailController');
Route::resource('attachment/attachment', 'Attachment\\AttachmentController');
Route::resource('message/message', 'Message\\MessageController');
Route::resource('progre/progre', 'Progre\\ProgreController');
Route::resource('userInsight/user-insight', 'UserInsight\\UserInsightController');
Route::resource('taskInsight/task-insight', 'TaskInsight\\TaskInsightController');
...
Route::resource('feature/feature', 'Feature\\FeatureController');
Route::resource('howItWorks/how-it-works', 'HowItWorks\\HowItWorksController');
Route::resource('faq/faq', 'Faq\\FaqController');
Route::resource('contact/contact', 'Contact\\ContactController');
Route::resource('taskLog/task-log', 'TaskLog\\TaskLogController');
Route::resource('socialMedia/social-media', 'SocialMedia\\SocialMediaController');

Route::resource('information/information', 'Information\\InformationController');
Route::resource('coworkerRequest/coworker-request', 'CoworkerRequest\\CoworkerRequestController');